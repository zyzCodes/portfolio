  ...
  return (
    <div className="hero min-h-screen relative">
      <div className="absolute inset-0 z-0">
        <Image src={mountains} alt="Hero Background" className="w-full h-full object-cover" />
      </div>
      <div className="hero-content text-center bg-black shadow-xl rounded-lg p-8 md:p-12 relative z-10 max-w-screen-xl mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="grid-col">
              <Link href="portfolio/">
                <button className="btn bg-sky-200">Portfolio</button>
              </Link>
            </div>
            <div className="grid-col">
              <Link href="#contact">
                <button className="btn bg-sky-200">Contact me</button>
              </Link>
            </div>
          </div>
        </div>
