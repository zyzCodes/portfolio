        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="portfolio/" className="group">
              <button className="modern-btn primary-btn group-hover:scale-105 transition-all duration-300">
            ...
            <Link href="mailto:aranasol@ualberta.ca" className="group">
              <button className="modern-btn secondary-btn group-hover:scale-105 transition-all duration-300">
                <span className="flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
