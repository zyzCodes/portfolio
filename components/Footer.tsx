...
const Footer = () => {
    return (
        <footer className="footer bg-base-200 text-center py-4 bottom-0 w-full">
            <div id="contact" className="flex flex-col items-center mx-auto">
                <h3 className="text-lg font-bold mb-2">Thank you for visiting my site, Feel free to contact me!</h3>
